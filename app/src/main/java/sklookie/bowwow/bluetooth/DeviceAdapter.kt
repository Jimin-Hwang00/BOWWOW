...
import sklookie.bowwow.databinding.ActivityBlutoothItemBinding
...
class DeviceAdapter(val devices: ArrayList<BluetoothDto>) : RecyclerView.Adapter<DeviceAdapter.DeviceViewHolder> (){
    ...
    class   DeviceViewHolder(val itemBinding: ActivityBlutoothItemBinding, listener: OnItemClickListener) : RecyclerView.ViewHolder(itemBinding.root){
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DeviceViewHolder {
        val itemBinding = ActivityBlutoothItemBinding.inflate(LayoutInflater.from(parent.context), parent, false)
